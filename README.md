...
* **Version**: Since a protocol may vary over the years, this message lement is needed to differentiate between the different versions of the applied protocol definition. The current version is 0x13, which represents version "1.3".
